...
import BannerImg from "../../assets/pic.jpg";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            ...
            >
              ...
              Voluptatibus cum ducimus a sequi odio, amet accusamus velit
              molestiae nostrum quas molestias dolores aperiam, saepe libero
              praesentium earum eaque ipsa sint?
            </p>
